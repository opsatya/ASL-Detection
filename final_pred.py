...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model(r"/home/satya/Documents/Blue/projects/development/asl-detection/model/cnn8grps_rad1_model (3).h5")
        ...
        try:
            ...
            if cv2image.any:
                ...
                if hands[0]:
                    ...
                    white = cv2.imread(r"/home/satya/Documents/Blue/projects/asl-detection/white.jpg")
